          ...
          <div className="divide-y divide-outline-variant/10">
            {FEEDBACK_ENTRIES.map((entry) => (
              <div key={entry.id} className="p-8 flex gap-6 hover:bg-surface-container-low transition-colors">
                <div className={cn('w-12 h-12 rounded-2xl flex items-center justify-center shrink-0', entry.sentiment === 'POS' ? 'bg-primary-fixed text-primary' : 'bg-error-container text-error')}>
